...
aggregate(customers_sample[, 2:4], by = list(members), length)

customers_sample$customer_group = members
customers_sample[which(customers_sample$customer_id==260 | customers_sample$customer_id==5920), ]
