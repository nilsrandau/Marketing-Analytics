...
customers_2015$segment = factor(x = customers_2015$segment, levels = c("inactive", "cold",
                                                             ...
                                                             "active high value", "active low value", "new active high", "new active low"))
table(customers_2015$segment)
aggregate(x = customers_2015[, 2:5], by = list(customers_2015$segment), mean)
...
table(customers_2015$segment)
#1
length(customers_2015$segment[which(customers_2015$segment == "new active low")])
#2
length(customers_2015$segment[which(customers_2015$segment == "new active high")])/length(customers_2014$segment[which(customers_2014$segment == "new active high")])
#3
mean(forward$revenue_2015[which(forward$segment == "new warm")])
#4
